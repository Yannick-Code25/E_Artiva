...
//   // CHANGEMENT: Nouvel effet pour déclencher le fetch des produits similaires
//   useEffect(() => {
//     if (product) {
...
//                 size={24}
//                 color={isInWishlist ? "tomato" : textColor}
//               />
//             </TouchableOpacity>
//           ),
//         }}
...
//   }, // Garde une couleur neutre pour le fond de l'image
//   carouselImage: { width: "100%", aspectRatio: 1.1,     resizeMode: 'cover', // Ajuste l'image pour couvrir l'espace sans déformation
//  },
...
//     fontSize: 15,
//     overflow: "hidden",
//   }, // overflow: hidden pour les coins arrondis sur iOS
// });
...
export default function ProductDetailScreen() {
  ...
  const renderImageItem = ({ item }: { item: ProductImageGalleryItem }) => (
    <View style={[styles.carouselImageContainer, {backgroundColor: colors.card}]}> 
      <Image
        source={{ uri: item.image_url }}
        style={styles.carouselImage}
        resizeMode="contain"
  ...
  return (
    ...
    >
      ...
      {product.imagesForCarousel && product.imagesForCarousel.length > 0 ? (
        ...
        <View style={[styles.imagePlaceholderContainer, {backgroundColor: colors.card}]}>
          <Text style={{ color: subtleTextColor }}>Pas d'image disponible</Text>
        </View>
      )}
